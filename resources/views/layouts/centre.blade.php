...
<body>
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
      <li class="{{route_active('centre')}}"><a href="{{ route('centre') }}"><em class="fa fa-dashboard">&nbsp;</em>Accueil</a></li>
      <li class="{{route_active('rapportC')}}"><a href="{{ route('rapportC') }}"><em class="fa fa-cog">&nbsp;</em>Rapport</a></li>
      <li>
